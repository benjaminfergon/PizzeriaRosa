...
import com.proyecto.dam.service.UploadFileService;
...
public class ProductoController {
	...
	@PostMapping("/update")
	public String update(Producto producto, @RequestParam("img") MultipartFile file, RedirectAttributes flash)
			throws IOException {
		...
		flash.addFlashAttribute("success", "Producto con el id " + producto.getId() + " actualizado correctamente");
		return "redirect:/productos";
	}
	...
	public String delete(@PathVariable Integer id, RedirectAttributes flash) {
		...
		flash.addFlashAttribute("success", "Producto borrado correctamente");
		return "redirect:/productos";
	}
